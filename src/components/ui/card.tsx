...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        "border-foreground/10 bg-card text-card-foreground overflow-hidden  text-xs/relaxed border has-data-[slot=card-footer]:pb-0 has-[>img:first-child]:pt-0 data-[size=sm]:gap-2 data-[size=sm]:py-3 data-[size=sm]:has-data-[slot=card-footer]:pb-0 *:[img:first-child]:rounded-none *:[img:last-child]:rounded-none group/card flex flex-col py-2 rounded-md",
        className,
      )}
      {...props}
    />
