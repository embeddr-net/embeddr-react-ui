  ...
  return (
    ...
    >
      <ScrollAreaPrimitive.ScrollAreaThumb
        ...
        className="cursor-pointer hover:bg-primary/20 bg-border relative flex-1 rounded-md border border-transparent hover:border-foreground/30 bg-clip-padding"
      />
    </ScrollAreaPrimitive.ScrollAreaScrollbar>
  );
}
